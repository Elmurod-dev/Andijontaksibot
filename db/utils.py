...
class CreatedModel(Base, AbstractClass):
    ...
    created_at = Column(DateTime(), default=datetime.datetime.utcnow() + datetime.timedelta(hours=5))
    updated_at = Column(DateTime(), default=datetime.datetime.utcnow() + datetime.timedelta(hours=5), onupdate=datetime.datetime.utcnow() + datetime.timedelta(hours=5))